 ...
 *
 * @typedef CloudinaryPluginConfig
 * @prop {CloudinaryConfig} cloudinary
 *
 * @typedef {import('../src/_data/eleventyComputed').OGData} OGData
 */
 ...
 * @param {CloudinaryPluginConfig} config
 */
